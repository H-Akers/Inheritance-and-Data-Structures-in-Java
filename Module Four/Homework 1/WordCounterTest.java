...
class WordCounterTest {
	...
	void testGetWordsOccuringMoreThan() {
		...
		ArrayList<String> ls5 = wc.getWordsOccuringMoreThan(0);
		System.out.println("ls5: " + ls5.size());
		assertTrue(ls5.size() >= 41400 & ls5.size() <= 42400);
		ArrayList<String> ls6 = wc.getWordsOccuringMoreThan(0);
		System.out.println("ls6: " + ls6.size());
		assertTrue(ls6.size() >= 41400 & ls6.size() <= 42400);
	}
